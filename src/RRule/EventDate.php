...
class EventDate
{
    ...
    {
        $this->dateStart = $eventData['date_start']->value();
        $this->allDay = $eventData['all_day']->value();
        $this->dateTimeStart = $eventData['date_time_start']->value();
        $this->dateTimeEnd = $eventData['date_time_end']->value();
        $this->recurrenceFrequency = $eventData['recurrence_frequency']->value()->value();
        $this->recurrenceCustomInterval = $eventData['recurrence_custom_interval']->value();
        $this->recurrenceCustomPeriod = $eventData['recurrence_custom_period']->value()->value();

        /* Repeat the event including the "until" date */
        $recurrenceUntilValue = $eventData['recurrence_until']->value();
