...
class FieldsManager
{
  public static function addFields()
  {
    ...
    if (!$graphQLEntryTypeNames) {
      return;
    }

    foreach ($graphQLEntryTypeNames as $typeName) {
      GraphQL::addField($typeName, 'occurrences', function () {
        return [
      ...
      GraphQL::addField($typeName, 'occurrencesAfter', function () {
        return [
          "type" => GraphQL::type('[Occurrence!]!'),
          'args' => [
            "after" => [
      ...
      GraphQL::addField($typeName, 'occurrencesBetween', function () {
        return [
          "type" => GraphQL::type('[Occurrence!]!'),
          'args' => [
            "from" => [
      ...
      GraphQL::addField($typeName, 'occurrencesAfterNow', function () {
        return [
          "type" => GraphQL::type('[Occurrence!]!'),
          'args' => [
            "limit" => [
      ...
      GraphQL::addField($typeName, 'humanReadableRRules', function () {
        return [
          "type" => GraphQL::type('[String!]!'),
          'args' => [
            "locale" => [
